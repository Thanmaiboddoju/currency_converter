...
class CurrencyConverterUi(tk.Tk):
    def __init__(self, converter):
        ...
        self.date_label = Label(self,text=f"1 Indian Rupee equals ="+
                                str(self.currency_converter.convert('INR','USD',1))+
                                "USD \n Date:"+str(self.currency_converter.data['date']),
        ...
        self.converted_amount_field_label=Label(self,text="INR",fg="black",
...
obj = RealTimeCurrencyConverter(url)
print(obj.convert("INR", "USD", 100))

CurrencyConverterUi(obj)
